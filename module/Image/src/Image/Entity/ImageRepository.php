...
class ImageRepository extends EntityRepository
{
    public function getFeatureds($reference = null,$reference_id = null,$category = null)
    {
        ...
        if($reference != null)
        {
            $db_reference_image = $this->getEntityManager()->getRepository('Image\Entity\ReferenceImage')->findOneByChave($reference);
        ...
        if($category != null)
        {
            ...
            if($category instanceof Category)
            {
                ...
                $db_category = $this->getEntityManager()
                    ->getRepository('Image\Entity\CategoryImage')
    ...
    public function getLastImages($reference = null,$reference_id = null, $category = null,$db_user = null)
    {
        $where = "";
        ...
        if($db_user != null)
        {
            $where .= " AND i.user = ".$db_user->getId();
        }
