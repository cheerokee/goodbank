 ...
 * @ORM\Entity
 * @ORM\Entity(repositoryClass="Image\Entity\ImageRepository")
 */
class Image
{
    /**
    ...
    /**
     * @var \Image\Entity\ReferenceImage
     *
     * @ORM\ManyToOne(targetEntity="Image\Entity\ReferenceImage")
     * @ORM\JoinColumns({
    ...
    /**
     * @var \Image\Entity\CategoryImage
     *
     * @ORM\ManyToOne(targetEntity="Image\Entity\CategoryImage")
     * @ORM\JoinColumns({
