...
class AdministratorController extends CrudController{
    public function __construct() {
        $this->title = $this->translate("Administradores");
        $this->table = 'Administrator';
        $this->entity = 'Register\Entity\User' ;
        $this->service = 'Register\Service\User' ;
        $this->form = 'Administrator\Form\\'.$this->table ;
        $this->controller = "administrator";
    ...
    public function  indexAction($list = null)
    {
        ...
        $list = $service->canList($this->entity,'administrador');
